...
# The following public_ip block has two changes compared to the original course code.
# We've modified the allocation_method from "Dynamic" to "Static"
# and added a "sku" argument and gave it the value "Standard".
